...
var AjouterArticlePage = /** @class */ (function () {
    function AjouterArticlePage(loginService, articlesService, loadingCtrl, camera, alertCtrl, router, formBuilder) {
    ...
    AjouterArticlePage.prototype.ngOnInit = function () {
    };
    AjouterArticlePage.prototype.creerAnnonce = function (articleForm) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!!articleForm.valid) return [3 /*break*/, 1];
                    ...
                    case 3:
                        ...
                        this.articlesService.addArticle(article).then(function () {
    ...
    AjouterArticlePage.prototype.updatePhoto = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var options;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
    ...
    AjouterArticlePage = tslib_1.__decorate([
        Component({
            selector: 'app-ajouter-article',
            templateUrl: './ajouter-article.page.html',
            styleUrls: ['./ajouter-article.page.scss'],
        }),
        tslib_1.__metadata("design:paramtypes", [LoginService, ArticlesService,
...
export { AjouterArticlePage };
//# sourceMappingURL=ajouter-article.page.js.map